...
namespace ImGui
{
	...
	IMGUI_API void          StyleColorsSpectrum();    // new, recommended style (default)
	...
	IMGUI_API bool		InputUInt8(const char* label, unsigned char* v, int step = 1, int step_fast = 100, ImGuiInputTextFlags flags = 0);
